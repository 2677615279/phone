...
<head>
    ...
    <script src="/js/wonderland.js" type="text/javascript"></script>
    <style type="text/css">
        .layui-col-xs6{
            width:220px;
            height:90px;
...
<div class="layui-card" style="width: 520px; height: 310px;float:left;">
    <div class="layui-card-header">销售额及订单量趋势</div>
    <div class="layui-card-body" id="order" style="width: 520px; height: 260px;"></div>
</div>
<div class="layui-card" style="width: 560px; height: 310px;float:left;margin-left:15px;">
    <div class="layui-card-header">手机销量排行</div>
    <div class="layui-card-body" id="volume" style="width: 560px; height: 260px;"></div>
</div>
</body>
<script type="text/javascript">
    ...
    $(function(){
        ...
        $.ajax({
            type:"post",
            url:"/api/orders/selectTotalMoneyByMonth",
            dataType:"json",
            success:function(res){
        ...
        $.ajax({
            type:"post",
            url:"/api/guess/selectMostHotGoods",
            dataType:"json",
            success:function(res){
