...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/index.jsp">乐享手机商城</a>
        </div>
    </div>
</nav>
...
<div class="layui-trans layadmin-user-login-footer">
    ...
    <p>© 2020 <a href="/index.jsp" target="_self">LEMarket.com</a></p>
    <p>
        <span><a href="/index.jsp" target="_self">前往首页</a></span>
        <span><a href="/login.jsp" target="_self">前往前台</a></span>
    </p>
</div>
