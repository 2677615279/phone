...
<div class="container-fluid">
    ...
    <div style="width:700px;height:auto;margin:0 auto;">
        <form class="layui-form" id="userInfo" method="post" style="height: 660px">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="username" id="userName" required
                           ...
                           class="layui-input" style="margin-top: 150px" />
                </div>
            </div>
            ...
            <div class="layui-form-item" style="color: darkred; text-align: center">以下为非必填项，可根据需要，进行修改</div>
            <div class="layui-form-item">
        ...
        form.on('submit(updateInfo)',function(){
            if ($("#previewImg").attr("src") === "/uploads/users_imgs/<shiro:principal property="img"/>") {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.message === "success"){
                            layer.msg("修改信息成功！",{icon:1,anim:4,time:2000,shade:0.4},function(){
                            });
                        }else{
                            layer.msg("修改信息失败！请重试！",{icon:5,anim:6,time:2000,shade:0.4});
                        }
